...
(function() {
  ...
  var newUserTypeSelectionView = {
    ...
    updateSelection: function (type) {
      view.forEach(view.getElements(this.element, 'li'), function newUserUpdateReset (el) {
    ...
    clearSelection: function () {
      view.forEach(view.getElements(this.element, 'li'), function newUserClearReset (el) {
        view.removeClass(el, 'selected');
      });
    }
  };
  ...
  var existingUserSelectionView = {
    ...
    updateSelection: function (userID) {
      view.forEach(view.getElements(this.element, 'li'), function existingUserUpdateReset (el) {
    ...
    hideSelection: function (id) { 
      view.hideElement(view.getElement(this.element, '[data-id="' + id + '"]'));
    },
    clearSelection: function () {
      view.forEach(view.getElements(this.element, 'li'), function existingUserClearReset (el) {
        view.removeClass(el, 'selected');
      });
    },
  ...
  var updateUserFormView = {
    ...
    reset: function () {
      ...
      view.showInlineBlockElement(submitButtonEl);
      view.showInlineBlockElement(cancelButtonEl);
      view.showInlineBlockElement(deleteButtonEl);
      view.hideElement(closeButtonEl);
      view.forEach(inputFieldEls, view.clearElementValue);
    },
  ...
  updateUserFormView.element.addEventListener('click', function onButtonClick (e) {
    ...
    if (view.hasClass(e.target, 'delete')) {
      updateUserFormView.hide();
      updateUserFormView.reset();
      existingUserSelectionView.clearSelection();
      existingUserSelectionView.hideSelection(targetUser.id);
